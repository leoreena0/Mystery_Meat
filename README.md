...
-----------------------------  ------------------------------------------------------------
all_sequences.fasta            Combined FASTA file containing reference mitochondrial
                               sequences and mystery samples

translate_sequences.py         Python script to translate DNA sequences and extract the
