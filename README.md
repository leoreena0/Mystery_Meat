...
**Jalview** was used separately for alignment and **iTOL** for tree construction
...
Nucleotide trees constructed in iTOL were used as the primary evidence for sample identification.
